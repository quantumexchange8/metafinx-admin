...
<template>
    <div class="flex flex-col gap-8 py-8 px-5 w-3/5">
        <div class="flex flex-col gap-2 p-5 w-full dark:bg-gray-700 items-center rounded-lg">
            ...
            <div class="flex flex-col gap-5">
                <div class="flex flex-col gap-1 md:grid md:grid-cols-4">
                    ...
                    <div class="md:col-span-3">
                        ...
                        <span class="text-xs text-[#FF2D55]">Each ticket holder will gain ${{ formatAmount(form.amount / test) }} per ticket.</span>
                    </div>
                </div>
                <div class="flex flex-col gap-1 md:grid md:grid-cols-4">
