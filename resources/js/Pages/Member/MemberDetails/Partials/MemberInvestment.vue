...
<template>
    <h3 class="text-xl font-semibold leading-tight my-5 md:my-0">
        Member's Investment
    </h3>

    <div class="flex whitespace-nowrap overflow-x-auto mb-5 md:0 md:grid md:grid-cols-1 gap-5">
        <div v-for="investment in props.investments" class="flex-1 px-5 pt-5 pb-2 bg-white rounded-[20px] border dark:border-gray-600 dark:bg-gray-700 shadow-[0_0_12px_0] dark:shadow-[#9da4ae33]">
            <div class="flex justify-between w-64 md:w-full">
                <div class="text-xs">
            ...
            <div class="flex justify-between mb-1">
                ...
                <div class="dark:text-white text-xs">
                    <span class="uppercase">
                        {{ formatDate(investment.next_roi_date) }}
                    </span>
                </div>
            </div>
            <div class="flex justify-between mb-1">
                ...
                <div class="dark:text-white text-xs">
                    <span class="uppercase">
                        {{ formatDate(investment.expired_date) }}
                    </span>
                </div>
            </div>
            <div class="flex justify-between mb-1">
            ...
            <div class="flex mt-3 text-xs justify-between items-center">
                <div>
                    <span class="dark:text-gray-400">*T&Cs apply. </span>
                    <span class="dark:text-white underline cursor-pointer dark:hover:text-gray-300" @click="openTncModal">Learn more.</span>
                </div>
                <Action
                    v-if="investment.status !== 'Terminated' && investment.status !== 'MaturityPeriod'"
                    type="investment"
