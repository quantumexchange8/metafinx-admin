...
<template>
    <form
        @submit.prevent="form.patch(route('member.edit_member'))"
    >
        <div class="flex flex-col gap-4 md:gap-8 mb-8">
            <div class="flex flex-col gap-1 md:grid md:grid-cols-4">
                ...
                <!-- <span class="flex flex-row items-center gap-3 col-span-3 rounded-lg text-base text-black dark:text-white dark:bg-gray-600 px-3 py-2">{{ member_details.name }}</span> -->
                <Input
                    id="name"
                    type="text"
                    class="flex flex-row items-center gap-3 md:col-span-3 rounded-lg text-base text-black dark:text-white dark:bg-gray-600 px-3 py-0"
                    v-model="form.name"
                    required
                    autofocus
                    autocomplete="name"
            ...
            <div class="flex flex-col gap-1 md:grid md:grid-cols-4">
                ...
                <!-- <span class="flex flex-row items-center gap-3 col-span-3 rounded-lg text-base text-black dark:text-white dark:bg-gray-600 px-3 py-2">
                    <PhoneIcon aria-hidden="true" class="w-5 h-5" />{{ member_details.phone }}
                </span> -->
                <InputIconWrapper class="flex flex-row items-center gap-3 md:col-span-3 rounded-lg text-base text-black dark:text-white dark:bg-gray-600">
                    <template #icon>
            ...
            <div class="flex flex-col gap-1 md:grid md:grid-cols-4">
                ...
                <!-- <span class="relative flex flex-row items-center gap-3 col-span-3 rounded-lg text-base text-black dark:text-white dark:bg-gray-600 px-3 py-2">
                    <KeyIcon aria-hidden="true" class="w-5 h-5 dark:text-gray-400" />{{ member_details.password }}
                    <div
                ...
                <InputIconWrapper class="relative flex flex-row items-center gap-3 md:col-span-3 rounded-lg text-base text-black dark:text-white dark:bg-gray-600">
                    <template #icon>
            ...
            <div class="flex flex-col gap-1 md:grid md:grid-cols-4">
                <span class="text-sm dark:text-white">Ranking</span>
                    <BaseListbox
                        class="md:col-span-3 rounded-lg text-base text-black dark:text-white dark:bg-gray-600"
            ...
            <div class="flex flex-col gap-1 md:grid md:grid-cols-4">
                <span class="text-sm dark:text-white">Upline</span>
                    <BaseListbox
                        class=" md:col-span-3 rounded-lg text-base text-black dark:text-white dark:bg-gray-600 overflow-y-visible "
                        v-model="uplineID"
                        :options="uplineList"
