...
const fetchData = async () => {
    try {
        ...
        const response = await axios.get('/report/getTotalPayoutByMonths/StandardRewards/standard', { params: { year: year.value , search: searchChart.value , date: dateChart.value } });
