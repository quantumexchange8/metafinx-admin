...
const fetchData = async () => {
    try {
        ...
        const response = await axios.get('/report/getTotalPayoutByMonths/PairingEarnings/standard', { params: { year: year.value , search: searchChart.value , date: dateChart.value } });
